...
cp ~/containers/la-plazeta-betatest/docker/scripts/templates/server_spawnpoints.lua.template "/project-zomboid-config/Server/${SERVER_NAME}_spawnpoints.lua"

cp ~/containers/la-plazeta-betatest/docker/scripts/templates/server_spawnregions.lua.template "/project-zomboid-config/Server/${SERVER_NAME}_spawnregions.lua"

cp ~/containers/la-plazeta-betatest/docker/la-plazeta-betatest_SandboxVars_backup.lua "/project-zomboid-config/Server/${SERVER_NAME}_SandboxVars.lua"
